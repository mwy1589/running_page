...
TRANS_GCJ02_TO_WGS84 = eviltransform is not None
...
def parse_raw_data_to_nametuple(
    ...
    if run_data["geoPoints"]:
        ...
        if TRANS_GCJ02_TO_WGS84 and eviltransform is not None:
            run_points_data = [
            ...
            run_points_data = [
                [p["latitude"], p["longitude"]] for p in run_points_data_gpx
            ]
